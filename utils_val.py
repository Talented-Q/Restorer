...
# --- Calculate the average PSNR --- #
        ...
        if save_tag:
            # print()
            save_image(pred_image, exp_name, 'RealBlur_R')
...
def validation_val(net, val_data_loader, device, exp_name, category, save_tag=True):
...
# --- Calculate the average PSNR --- #
        ...
        if save_tag:
            # print()
            save_image(pred_image, exp_name, category)

    avr_psnr = sum(psnr_list) / len(psnr_list)
    avr_ssim = sum(ssim_list) / len(ssim_list)
    return avr_psnr, avr_ssim

def save_image(pred_image, exp_name, category):
    ...
    for ind in range(batch_num):
        ...
        print(ind)
        utils.save_image(pred_image_images[ind], './results/{}/{}/{}.png'.format(category,exp_name,ind))
